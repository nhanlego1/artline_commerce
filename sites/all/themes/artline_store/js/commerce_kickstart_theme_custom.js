...
//      
//      if ($(".menu-sub-mobile").hasClass('hide-mobile')) {
//        $(".menu-sub-mobile .toggler-mobile").click(function () {
//          $(".block-menu-menu-user-menu").addClass('hide-wrapper');
//          $(".menu-sub-mobile").removeClass('hide-mobile');
//        });
//      } else {
//        $(".menu-sub-mobile .toggler-mobile").click(function () {
//          $(".block-menu-menu-user-menu").addClass('hide-wrapper');
//          $(".menu-sub-mobile").addClass('hide-mobile');
//        });
//      }
      $(".menu-sub-mobile .toggler-mobile").click(function () {
